...
%This allows storing many keyswitch hints on chip.
...
%At $L = 24$, keyswitch hints using the standard method are 72\,MB, whereas the 
...
\autoref{fig:f1dataMovement} shows that keyswitch hints dominate in high-depth workloads
