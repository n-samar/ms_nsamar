...
\section{General FHE Opportunities and Challenges}
\label{sec:general}
...
Moreover, F1 and prior work has employed FHE algorithms that require even
...
We evaluate CraterLake on a broad range of FHE benchmarks, including programs
