...
RNS representation \cite{garner:1959:residue}  % victor asked for a ``reassuring read-more-about-RNS citation''
...
%Each automorphism, in addition to ciphertext multiplication, requires a different pair of keyswitch hint matrices.
