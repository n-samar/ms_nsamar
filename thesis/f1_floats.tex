...
\newcommand{\figFOneArch}{
  \begin{figure}[t]
        \begin{center}
     \includegraphics{f1_figures/ag_arch.pdf}
...
\newcommand{\figFOneMultDataflow}{
  \begin{figure}[t]
        \begin{center}
     \includegraphics[width=0.99\columnwidth]{f1_figures/ag_mult_dataflow.pdf}
...
\newcommand{\figFOneOpBreakdown}{
    \begin{figure}[t]
    \begin{center}
        \includegraphics[width=0.99\columnwidth]{f1_plots/lolaptwTimeplot.pdf}
        \vspace{-0.05in}
...
\newcommand{\figFOneCompilerOverview}{
  \begin{figure}[t]
        \begin{center}
     \includegraphics[width=\columnwidth]{f1_figures/ag_compiler_overview.pdf}
...
\newcommand{\figFOneAutomorphism}{
  \begin{figure}[t]
        \begin{center}
    \includegraphics[width=0.99\columnwidth]{f1_figures/ag_automorphism.pdf}
...
\newcommand{\figFOneFourStepNTT}{
  \begin{figure}[t]
    \includegraphics[width=0.99\columnwidth]{f1_figures/ag_four_step_ntt.pdf}
...
\newcommand{\figFOneQuadrantSwap}{
  \begin{figure}[t]
    \centering
    \includegraphics[width=0.99\columnwidth]{f1_figures/ag_quadrant_swap.pdf}
...
\newcommand{\figFOneOverview}{
  \begin{figure}[h] % dsm: acmart crap bleeds onto the second column, makes it hard for this figure to be on top, so make it [h]
    \vspace{-0.07in} % dsm: equalize [h] margins
    \centering
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.49\columnwidth}
    ...
    \label{fig:power}
  \end{subfigure}
  % dsm: Extremely ghetto superimposed subfigure labels
  %\vspace*{-0.31in}
  \begin{center}
...
\newcommand{\figFOneConfigs}{
  ...
  \begin{wrapfigure}{t}{0.5\linewidth}
    \begin{center}
    \vspace{-0.3in}
     \includegraphics[width=0.5\columnwidth]{f1_plots/configs.pdf}
