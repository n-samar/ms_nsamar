...
\newcommand{\figBootstrapping}{
    \begin{figure}[t]
        \begin{center}
            \includegraphics[width=0.85\columnwidth]{figures/ag_bootstrapping.pdf}
...
\newcommand{\figBootstrappingFrequency}{
  \begin{figure}[t]
    \begin{center}
        \includegraphics[width=\columnwidth]{figures/ag_bootstrappingFrequency.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.9\columnwidth]{plots/utils.pdf}
...
\newcommand{\figCRB}{
  ...
  \begin{figure}[t]
      \begin{center}
      \includegraphics[width=0.7\columnwidth]{figures/ag_crb.pdf}
        ...
        \begin{center}
            \begin{footnotesize}
                \begin{tabular}{lrr|rr}
                    ...
                    \bottomrule
               \end{tabular}
            \caption{Performance of \name at 128-bit security and at 240-bit ($N$=128k) with comparisons to performance at 80-bit security.}
...
\newcommand{\figGmeanVsStorage}{
    \begin{figure}
            \centering
            \includegraphics[width=0.8\columnwidth]{plots/scratchpad_sweep.pdf}
    ...
    \begin{table}[t]
        ...
        \begin{center}
            \begin{tabular}{lrrrr}
                ...
                \bottomrule
            \end{tabular}
            \caption{Speedups of \name over configurations without KSHGen, CRB or chaining, and the fixed network.}
