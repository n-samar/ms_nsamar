...
\def\titone{Designing a Programmable Hardware Accelerator}
\def\tittwo{for Fully Homomorphic Encryption} 
\def\author{Axel S. Feldmann} 
\def\addrone{67 Bristol St.}
